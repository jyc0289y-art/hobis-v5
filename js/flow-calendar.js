    ...
    if ((ev.attendees||[]).length) {
        ...
        html += `<div class="fc-detail-section"><div class="fc-ds-title">ATTENDEES (${ev.attendees.length})</div><div class="fc-attendees">
            ...
            ${ev.attendees.map(a => {
                ...
                if (a.status === 'ë¶ì°¸') { chipColor = 'var(--hobis-alert)'; chipBg = 'rgba(255,51,0,0.1)'; }

                else if (a.status === 'ë¯¸ì ') { chipColor = 'var(--hobis-warn)'; chipBg = 'rgba(255,204,0,0.1)'; }
...
function fcShowDetail(id) {
    ...
    if (fcIsDesktop()) {
        ...
        // PC: overlay modal â uses .panel style matching right-column design
        ...
        // Mobile: inline detail below current view â same .panel style
